                ...
                if (isset($administradores) && !empty($administradores)) {
                    foreach ($administradores as $admin) {
                        ...
                        echo "<td>
                                ...
                                <a href='index.php?route=Admin/ActualizarUser&id=".htmlspecialchars($admin['id'])."&from=Admin/ListarAdmins' class='btn edit-btn'>Actualizar</a>
                                    <a href='index.php?route=Admin/DeleteUser&id=".htmlspecialchars($admin['id'])."' class='btn delete-btn' data-confirm='¿Eliminar este usuario?'>Eliminar</a>
                                </div>
                              </td>";
                        echo "</tr>";
                    }
